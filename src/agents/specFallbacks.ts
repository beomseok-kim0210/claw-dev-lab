...
export function buildDeterministicBackendSpec(args: {
  ...
  return {
    ...
    apiDesign: pickList(
      args.backendDiscussion.apiDesign,
      3,
      6,
      [
    ...
    dataModel: pickList(
      args.backendDiscussion.dataModel,
      3,
      6,
      [
    ...
    constraints: pickList(
      args.backendDiscussion.constraints,
      2,
      5,
      [
...
export function buildDeterministicFrontendSpec(args: {
  ...
  return {
    ...
    screens: pickList(
      args.frontendDiscussion.screens,
      3,
      6,
      [
    ...
    components: pickList(
      args.frontendDiscussion.components,
      3,
      6,
      [
    ...
    usabilityChecklist: pickList(
      args.frontendDiscussion.usabilityNotes,
      2,
      5,
      [
...
export function buildDeterministicAIFeaturesSpec(args: {
  ...
  return {
    ...
    feasibilityNotes: pickList(
      args.aiDiscussion.feasibility,
      2,
      5,
      [
